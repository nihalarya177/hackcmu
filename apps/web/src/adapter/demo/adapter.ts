...
/**
 * Implemented against the simulated state today. `requestProcessing`, places,
 * stored bot actions and export are scripted-scenario and serializer work
 * (DEMO-1 to DEMO-3) and stay false until they exist, so no control is offered
 ...
 */
export function createDemoAdapter(storage: Storage | null): PlannerAdapter {
  ...
  return {
    ...
    requestProcessing: () => settle(() => unsupported('requestProcessing')),
